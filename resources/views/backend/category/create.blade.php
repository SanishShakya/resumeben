                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <div class="box-body">
                                    <h1 class="card-description" style="text-align: center;">Create Category<a href="{{route('backend.category.index')}}" class="btn btn-info" style="float: right; color: white"><i class="mdi mdi mdi-view-list"></i> List Category</a></h1>
