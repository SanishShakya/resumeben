...
@section('content')
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-body">
          <h1 class="card-description" style="text-align: center;">Edit Category<a href="{{route('backend.category.index')}}" class="btn btn-primary" style="float: right; color: white"><i class="mdi mdi mdi-view-list"></i> List Category</a></h1>
